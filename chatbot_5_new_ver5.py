        ...
        sys = (
            ...
            if is_traffic_safety:
                sys = (
                    ...
                    "\n"
                    "**[판단 규칙]**\n"
                    "1. 교통안전 관련 서술형은 다양한 표현 모두 인정:\n"
                    "   - 같은 개념을 다른 말로 표현하면 모두 정답\n"
                    "   - 원인과 결과 관계가 논리적이면 정답\n"
                    "   예시:\n"
                    "   • '속력이 빠르면 위험': '멈추기 힘들다', '사고나면 다친다', '제동거리 길다', '충돌 시 위험', '부상 위험' → 모두 O\n"
                    "   • '안전띠 역할': '몸을 고정', '튕겨나가지 않게', '안전하게', '보호해준다' → 모두 O\n"
                    "   • '에어백 역할': '충격 완화', '다치지 않게', '보호해준다', '부드럽게 받아줌' → 모두 O\n"
                    "\n"
